    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          {/* Contact Form */}
          <div className="bg-white rounded-2xl shadow-xl p-8 border-t-4 border-brand-200">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-brand-200 focus:border-transparent transition-all"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-brand-200 to-brand-200 text-white px-8 py-4 rounded-xl font-bold text-lg hover:from-brand-200 hover:to-brand-200 transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2 group"
            >
        ...
        <div className="space-y-6">
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg p-8 border-2 border-brand-200">
            ...
            <a href="tel:+254700000000" className="text-2xl font-bold text-brand-200 hover:text-brand-200 transition">
              +254 700 000 000
            </a>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl shadow-lg p-8 border-2 border-brand-200">
            ...
            <a href="mailto:info@saliproducts.co.ke" className="text-2xl font-bold text-brand-200 hover:text-brand-200 transition break-all">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-gray-200">
            <div className="flex items-center gap-3 mb-4">
              <Clock className="text-brand-200" size={24} />
