...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-400 to-blue-300 text-white py-20">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal animation="fade-right">
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-400">
          ...
          <div className="bg-gradient-to-r from-blue-400 to-blue-300 rounded-2xl shadow-xl p-10 mb-12 text-white">
            <div className="flex items-center gap-3 mb-6">
              <Target size={32} />
