...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      {/* Hero Section */}
      <div className="bg-gradient-to-r from-blue-200 to-blue-200 text-white py-20">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal animation="fade-right">
            <div className="bg-white rounded-2xl shadow-xl p-10 mb-12 border-t-4 border-blue-200">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all border-2 border-blue-200 perspective-container transform-3d hover-tilt-3d hover:animate-[pulse3d_2s_ease-in-out_infinite]">
              <div className="flex items-center justify-between mb-4">
                <h3 className="text-5xl font-bold text-blue-200">5000+</h3>
                <Zap className="text-blue-200" size={40} />
              </div>
          ...
          <div className="bg-gradient-to-r from-blue-200 to-blue-200 rounded-2xl shadow-xl p-10 mb-12 text-white">
            <div className="flex items-center gap-3 mb-6">
              <Target size={32} />
