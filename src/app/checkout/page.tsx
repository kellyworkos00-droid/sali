            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div>
                    <label className="block text-sm font-semibold mb-2">
                      County <span className="text-blue-400">*</span>
                    </label>
                    <input
                      type="text"
                      required
          ...
          <div>
            <div className="bg-white rounded-lg shadow-md p-6 sticky top-20">
              ...
              <button
                ...
                className="w-full bg-blue-400 text-white px-8 py-4 rounded-lg font-semibold hover:bg-blue-300 transition mt-6 disabled:bg-gray-400 disabled:cursor-not-allowed"
              >
