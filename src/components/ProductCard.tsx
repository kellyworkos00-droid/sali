      ...
      <div className="bg-white rounded-lg md:rounded-2xl shadow-md overflow-hidden hover:shadow-2xl transition-all duration-500 border border-gray-100 transform-3d hover-tilt-3d">
        <div className="relative h-32 sm:h-40 md:h-56 bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3">
            ...
            <div className="bg-blue-200 text-white p-3 rounded-full transform translate-y-4 group-hover:translate-y-0 transition-transform delay-75">
          ...
          <div className="absolute top-3 right-3">
            {product.stock > 0 ? (
              ...
              <span className="bg-blue-200 text-white text-xs font-bold px-3 py-1 rounded-full shadow-lg">
                Out of Stock
              </span>
            )}
          </div>
        ...
        <div className="p-2 sm:p-3 md:p-5">
          <h3 className="font-bold text-xs sm:text-sm md:text-lg mb-1 md:mb-2 line-clamp-2 text-gray-900 group-hover:text-blue-200 transition-colors">
            {product.name}
          </h3>
          ...
          <div className="flex items-center justify-between pt-2 md:pt-3 border-t border-gray-100">
            <span className="text-blue-200 font-bold text-sm sm:text-lg md:text-2xl">
